...
export interface CommandEncoderCreator extends BRAND<"CommandEncoderCreator"> {
    label(): UNSURE<string>;
...
@labeling({
    get: (instance: CommandEncoderCreator) => instance.labelValue,
    set: (instance: CommandEncoderCreator, label) => instance.cmdencoder.label = instance.labelValue = label
})
export class CommandEncoderCreator {
    ...
    constructor(device:GPUDevice,labelOrCommandEncoder:UNSURE<string>|GPUCommandEncoder){
        ...
        this.#label = typeof labelOrCommandEncoder === "string" ? labelOrCommandEncoder : labelOrCommandEncoder?.label;
