...
execSync(`pnpm pkg set scripts.minify:js="node --no-warnings minify-js.js"`)
execSync(`pnpm pkg set scripts.minify:dts="node --no-warnings minify-dts.js"`)
execSync(`pnpm pkg set scripts.minify:end="node --no-warnings minify-end.js"`)
execSync(`pnpm pkg set scripts.tsc="tsc"`)
execSync(`pnpm pkg set scripts.lint="eslint"`)
execSync(`pnpm pkg set scripts.build="node cmd/build.js"`)
execSync(`pnpm pkg set scripts.prepublishOnly="pnpm build"`)
